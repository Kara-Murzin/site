...
<?php include "../../app/include/sidebar-admin.php"; ?>
        ...
        <div class="posts col-9">
            <div class="button row">
                <a href="<?php echo BASE_URL . "admin/posts/create.php";?>" class="col-2 btn btn-success">Құру</a>
                <span class="col-1"></span>
                <a href="<?php echo BASE_URL . "admin/posts/index.php";?>" class="col-3 btn btn-warning">Өзгерту</a>
            </div>
            <div class="row title-table">
                <h2>Жазбаларды басқару</h2>
                <div class="mb-12 col-12 col-md-12 err">
                    <p><?=$_SESSION['error'];?></p>
                </div>
                <div class="col-1">ID</div>
                <div class="col-5">Аты</div>
                <div class="col-2">Авторы</div>
                <div class="col-4">Басқару</div>
            </div>
